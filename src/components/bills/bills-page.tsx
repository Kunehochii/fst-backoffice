...
import { Search, Receipt, Store, ChevronRight, Calendar } from "lucide-react";
...
export function BillsPage({ selectedDate, onDateChange, onSelectCashier }: BillsPageProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage daily bill counts across your branches</p>
        </div>
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                Choose a branch to view or edit its bill count for{" "}
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <p className="text-sm text-muted-foreground/70">
        Create a cashier first to start tracking bill counts
      </p>
    </div>
  );
}
